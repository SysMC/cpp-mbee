...
2. Отладочная плата MSP-EXP430G2ET семейства LaunchPad.
...
ВНИМАНИЕ!Для корректной работы кнопки BUTTON1 на плате MSP-EXP430G2ET необходимо снять перемычку J7 (P1.6).
